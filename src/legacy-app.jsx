...
import { Hero, HeroMarquee } from "./sections/Hero.jsx";
import { Evidence } from "./legacy-sections-evidence.jsx";
import { Diagnosis, Cause, Essence } from "./legacy-sections-cause.jsx";
import { Solution, ROI } from "./legacy-sections-solution.jsx";
import { Trust, CTA, Footer, MidCTA } from "./legacy-sections-trust.jsx";
import { HeroConsole } from "./legacy-hero-console.jsx";
import {
  useTweaks, TweaksPanel, TweakSection, TweakColor,
  TweakRadio, TweakSelect,
} from "./legacy-tweaks-panel.jsx";
