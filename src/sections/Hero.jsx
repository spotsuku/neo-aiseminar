    ...
    <div className="aircamp-hero">
      ...
      <header className="ac-nav" ref={navRef}>
        <nav className="ac-nav-right">
          ...
          <a className="ac-nav-link" href="#trust">受講実績</a>
      ...
      <section className="darkband" id="livebuild">
        <div className="ac-wrap">
          <div className="demo-statement rv">
            ...
            <p className="demo-sub rv">まずは自分の会社の<span className="demo-sub-br" aria-hidden="true" /><span className="ac-mark">現在地を知る</span>。</p>
          </div>
